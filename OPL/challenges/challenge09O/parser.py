    ...
    def switchStatement(self):
        ...
        while not self.check(TokenType.RIGHT_BRACE) and not self.isAtEnd():
            if self.match(TokenType.CASE):
                ...
                expr_def = self.expression()
                self.consume(TokenType.COLON, "Expect ':' after case expression.")
                cases.append(Case(expr_def, self.statement()))
    ...
    def synchronize(self) -> None:
        ...
        while not self.isAtEnd():
            ...
            if (tok_type == TokenType.CLASS):
                ...
                break
            elif tok_type == TokenType.VAR:
                break
            elif tok_type == TokenType.FOR:
                break
            elif tok_type == TokenType.IF:
                break
            elif tok_type == TokenType.WHILE:
                break
            elif tok_type == TokenType.PRINT:
                break
            elif tok_type == TokenType.SWITCH:
                break
